...
import DeveloperLink from './DeveloperLink.jsx';
...
export default function Footer ({handleClick}) {
    ...
    const footerSocialMedia = [
        {   svgXmls: "http://www.w3.org/2000/svg",
            viewBox: "0 0 448 512", 
            ...
            href: 'https://www.instagram.com/cortinascelesteazevedo'
        },
        {   svgXmls: "http://www.w3.org/2000/svg",
            viewBox: '0 0 512 512',
    ...
    return (
      <footer className="w-screen min-h-[50vh] bg-gray text-cream p-6 mx-auto">
        <img
          src={logo}
          alt="logo"
          className="rounded-full w-16 object-fit ml-0"
        />
        <div className='grid gap-6 justify-between md:flex md:justify-around md:items-center'>
                ...
                {footerSocialMedia.map((item, index) => (
                    <li key={index} className=''>
                        <a href={item.href} target='_blank' rel='noreferrer'>
                            <svg xmlns={item.svgXmls} viewBox={item.viewBox} className='fill-current hover:fill-navy text-beige transition-all duration-500 cursor-pointer w-8 h-8'>
                                <path d={item.path}/>
                            </svg>
                        </a>
                    </li>
        ...
        <div className='text-center mt-8 md:flex md:justify-center md:gap-4'>
            <p>Cortinas Celeste Azevedo</p>
